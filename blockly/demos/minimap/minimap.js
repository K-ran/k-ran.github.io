...
Minimap.scaleMinimap = function (){
        ...
        if((workspaceBoundingBox.y*Minimap.workspace.scale-workspaceMetrics.contentTop)*Minimap.minimap.scale/Minimap.workspace.scale>topPadding)
            topPadding=(workspaceBoundingBox.y*Minimap.workspace.scale-workspaceMetrics.contentTop)*Minimap.minimap.scale/Minimap.workspace.scale;
...
Minimap.updateMapDragger = function(e){
    ...
    var maxValidY = (Minimap.workspace.getMetrics().contentHeight-Minimap.workspace.getMetrics().viewHeight)*Minimap.minimap.scale;
